...
<template>
    ...
    <ul>
      <li>
        <strong>OpenFASoC:</strong> An Open Source Framework for Fully Automated Mixed-Signal SoC Generation.
        <a href="https://dl.acm.org/doi/abs/10.1145/3670474.3685971" target="_blank">Read More</a>
      </li>
      <li>
        <strong>GLayout Framework:</strong> Human Language to Analog Layout Using GLayout Layout Automation Framework.
        <a href="https://dl.acm.org/doi/abs/10.1145/3670474.3685971" target="_blank">Read More</a>
      </li>
      <li>
        <strong>Open Se Cura:</strong> First silicon results of an auditable and transparent hardware root-of-trust system.
        <a href="https://ieeexplore.ieee.org/abstract/document/10584369" target="_blank">Read More</a>
      </li>
      <li>
        <strong>Laser-Induced Graphene Sensors:</strong> Integrated sensing platforms for flexible wearables.
        <a href="https://ieeexplore.ieee.org/abstract/document/10584418" target="_blank">Read More</a>
      </li>
      <li>
        <strong>Cryogenic Models:</strong> Open-source cryogenic modeling for CMOS Sky130 at 4 K.
        <a href="https://doi.org/10.18434/mds2-2997" target="_blank">Read More</a>
      </li>
    </ul>
  </div>
  ...
  * {
  ...
  h1 {
    ...
    font-size: 2.5em; /* Enlarged title font size */
    margin-top: 0.5em;
    margin-bottom: 0.5em;
  }
  ...
  .profile-image {
    width: 300px; /* Adjust width for square image */
    height: 300px; /* Adjust height to match width for square aspect */
